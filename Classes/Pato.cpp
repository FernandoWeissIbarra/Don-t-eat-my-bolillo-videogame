...
Pato::Pato()
    ...
    , _life(2)             // Initial life points
    , damage(1)            // Damage dealt by Pato
...
// Factory method to create a Pato object
Pato* Pato::create() {
    Pato* pato = new Pato();
    if (pato && pato->init()) {
        pato->autorelease();
...
void Pato::reduceLife(int damage) {
    _life -= damage;
...
// Getter for Pato's life points
int Pato::getLife() {
    return _life;
}

// Initializes the Pato object
bool Pato::init() {
    // Create the sprite
    auto patoSprite = Sprite::create();
    if (!patoSprite->initWithFile("Pato/Armature_animtion0_00.png")) {
        return false; // Return false if the sprite couldn't be initialized
    }
    setScale(0.7f); // Set the initial scale

    // Spawn Pato at a random side of the screen
    spawnAtRandomSide();
...
void Pato::walkAnimation() {
    auto animation = cocos2d::Animation::create();

    // Add frames to the animation
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_00.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_01.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_02.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_03.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_04.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_05.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_06.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_07.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_08.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_09.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_10.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_11.png");
    animation->addSpriteFrameWithFile("Pato/Armature_animtion0_12.png");
...
void Pato::setTargetPosition(const cocos2d::Vec2& targetPosition) {
    _targetPosition = targetPosition;
}

// Spawns Pato at a random side of the screen
void Pato::spawnAtRandomSide() {
...
// Transforms Pato into a boss with enhanced attributes
void Pato::BossMode() {
    // Increase size
    setScale(1.3f);
