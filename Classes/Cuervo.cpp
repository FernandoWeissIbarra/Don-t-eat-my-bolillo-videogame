...
Cuervo::Cuervo()
    ...
    , _speed(100.f)        // Default movement speed
    , _life(5)             // Initial life points
    , damage(1)            // Damage dealt by Cuervo
...
// Factory method to create a Cuervo object
Cuervo* Cuervo::create() {
    Cuervo* cuervo = new Cuervo();
    if (cuervo && cuervo->init()) {
        cuervo->autorelease();
        return cuervo;
    }
    else {
...
void Cuervo::reduceLife(int damage) {
    _life -= damage;
...
// Getter for Cuervo's life points
int Cuervo::getLife() {
    return _life;
}

// Initializes the Cuervo object
bool Cuervo::init() {
    // Create the sprite
    auto cuervoSprite = Sprite::create();
    if (!cuervoSprite->initWithFile("Cuervo/Armature_animtion0_00.png")) {
        return false; // Return false if the sprite couldn't be initialized
    }
    setScale(0.7f); // Set the initial scale

    // Spawn Cuervo at a random side of the screen
    spawnAtRandomSide();
...
void Cuervo::walkAnimation() {
    auto animation = cocos2d::Animation::create();

    // Add frames to the animation
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_00.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_01.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_02.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_03.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_04.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_05.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_06.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_07.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_08.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_09.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_10.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_11.png");
    animation->addSpriteFrameWithFile("Cuervo/Armature_animtion0_12.png");
...
void Cuervo::setTargetPosition(const cocos2d::Vec2& targetPosition) {
    _targetPosition = targetPosition;
}

// Spawns Cuervo at a random side of the screen
void Cuervo::spawnAtRandomSide() {
...
// Transforms Cuervo into a boss with enhanced attributes
void Cuervo::BossMode() {
    // Increase size
    setScale(1.3f);
