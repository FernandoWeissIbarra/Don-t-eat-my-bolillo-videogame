...
Paloma::Paloma()
    ...
    , _speed(130.f)        // Default movement speed
    , _life(6)             // Initial life points
    , damage(1)            // Damage dealt by Paloma
...
// Factory method to create a Paloma object
Paloma* Paloma::create() {
    Paloma* paloma = new Paloma();
    if (paloma && paloma->init()) {
        paloma->autorelease();
        return paloma;
    }
    else {
...
void Paloma::reduceLife(int damage) {
    _life -= damage;
...
// Getter for Paloma's life points
int Paloma::getLife() {
    return _life;
}

// Initializes the Paloma object
bool Paloma::init() {
    // Create the sprite
    auto palomaSprite = Sprite::create();
    if (!palomaSprite->initWithFile("Paloma/Armature_animtion0_00.png")) {
        return false; // Return false if the sprite couldn't be initialized
    }
    setScale(0.7f); // Set the initial scale

    // Spawn Paloma at a random side of the screen
    spawnAtRandomSide();
...
void Paloma::update(float dt) {
    ...
    // Move Paloma towards the target
...
void Paloma::walkAnimation() {
    auto animation = cocos2d::Animation::create();

    // Add frames to the animation
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_00.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_01.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_02.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_03.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_04.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_05.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_06.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_07.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_08.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_09.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_10.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_11.png");
    animation->addSpriteFrameWithFile("Paloma/Armature_animtion0_12.png");
...
void Paloma::setTargetPosition(const cocos2d::Vec2& targetPosition) {
    _targetPosition = targetPosition;
}

// Spawns Paloma at a random side of the screen
void Paloma::spawnAtRandomSide() {
...
// Transforms Paloma into a boss with enhanced attributes
void Paloma::BossMode() {
    // Increase size
    setScale(1.3f);
